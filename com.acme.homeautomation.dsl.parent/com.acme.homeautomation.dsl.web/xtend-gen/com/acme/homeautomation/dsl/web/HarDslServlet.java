...
import com.acme.homeautomation.dsl.web.HarDslWebSetup;
...
public class HarDslServlet extends XtextServlet {
  ...
  public void init() {
    try {
      super.init();
      final Injector injector = new HarDslWebSetup().createInjectorAndDoEMFRegistration();
