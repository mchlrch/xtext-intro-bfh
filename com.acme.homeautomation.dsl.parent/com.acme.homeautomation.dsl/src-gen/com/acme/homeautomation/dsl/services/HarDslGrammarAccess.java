 ...
 */
package com.acme.homeautomation.dsl.services;
...
@Singleton
public class HarDslGrammarAccess extends AbstractGrammarElementFinder {
	
	public class ModelElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.acme.homeautomation.dsl.HarDsl.Model");
	...
	public class DeclarationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.acme.homeautomation.dsl.HarDsl.Declaration");
	...
	public class DeviceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.acme.homeautomation.dsl.HarDsl.Device");
		...
		//'device' name=ID 'can' 'be' states+=State*
	...
	public class StateElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.acme.homeautomation.dsl.HarDsl.State");
	...
	public class RuleElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.acme.homeautomation.dsl.HarDsl.Rule");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class QualifiedNameElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.acme.homeautomation.dsl.HarDsl.QualifiedName");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	@Inject
	public HarDslGrammarAccess(GrammarProvider grammarProvider,
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("com.acme.homeautomation.dsl.HarDsl".equals(grammar.getName())) {
				return grammar;
			}
