 ...
 * </p>
 * <ul>
 *   <li>{@link com.acme.homeautomation.dsl.harDsl.impl.RuleImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link com.acme.homeautomation.dsl.harDsl.impl.RuleImpl#getWhen <em>When</em>}</li>
 *   <li>{@link com.acme.homeautomation.dsl.harDsl.impl.RuleImpl#getThen <em>Then</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RuleImpl extends DeclarationImpl implements Rule
{
  ...
  {
    return HarDslPackage.Literals.RULE;
  }
  ...
  public void setDescription(String newDescription)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HarDslPackage.RULE__DESCRIPTION, oldDescription, description));
  }
  ...
  public State getWhen()
  {
    if (when != null && when.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, HarDslPackage.RULE__WHEN, oldWhen, when));
      }
    }
    return when;
  }
  ...
  public void setWhen(State newWhen)
  {
    ...
    when = newWhen;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HarDslPackage.RULE__WHEN, oldWhen, when));
  }
  ...
  public State getThen()
  {
    if (then != null && then.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, HarDslPackage.RULE__THEN, oldThen, then));
      }
    }
    return then;
  }
  ...
  public void setThen(State newThen)
  {
    ...
    then = newThen;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HarDslPackage.RULE__THEN, oldThen, then));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case HarDslPackage.RULE__DESCRIPTION:
        return getDescription();
      case HarDslPackage.RULE__WHEN:
        if (resolve) return getWhen();
        return basicGetWhen();
      case HarDslPackage.RULE__THEN:
